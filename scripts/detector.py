...
class Detector:
    ...
    def project_pixel_to_ray(self,u,v):
        ...
        ### YOUR CODE HERE ###
        z = (1/(((u-self.cx)/self.fx)**2 + ((v-self.cy)/self.fy)**2 +1))**0.5
        x = (u - self.cx)/self.fx * z # CHANGE ME
        y = (v - self.cy)/self.fy * z # CHANGE ME
    ...
    def camera_info_callback(self, msg):
        ...
        ### YOUR CODE HERE ###
        #principal point
        self.cx = msg.P[0][2] # CHANGE ME
        self.cy = msg.P[1][2] # CHANGE ME
        #Focal Length
        self.fx = msg.P[0][0] # CHANGE ME
        self.fy = msg.P[1][1] # CHANGE ME
